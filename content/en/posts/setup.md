...
The setup menu is accessed through the CLI by running `npx elva` and selecting "Setup" from the main menu, or by using the direct command shortcuts documented below.
